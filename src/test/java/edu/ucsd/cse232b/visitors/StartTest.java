...
class StartTest {
    ...
    void xq_join() throws Exception {
        edu.ucsd.cse232b.visitors.main.startxq(new String[]{"testfiles/xq_join.txt", "testfiles/xq_join.xml", "0"});
        edu.ucsd.cse232b.visitors.main.startxq(new String[]{"testfiles/xq_join.txt", "testfiles/xq_join_rws.xml", "1"});
    }
    ...
    void xq_join_2() throws Exception {
        ...
        edu.ucsd.cse232b.visitors.main.startxq(new String[]{"testfiles/xq_join_2.txt", "testfiles/xq_join_2_rw.xml"});
